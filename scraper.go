...
func main() {
	...
	c.OnScraped(func(r *colly.Response) {
		...
		// initialize a file writer with comma as the delimiter
		writer := csv.NewWriter(file)
		writer.Comma = ',' // ensure it's using a comma as the delimiter
		...
		writer.Flush() // make sure to flush the data to the file
	})
